        ...
        <div class="logo_right">
            <details id="header_menu" class="logo_right_img menu">
                ...
                <div class="list_box">
                    ...
                    <a class="pink_list" href="catalog.php?type=1">men</a>
                    <ul>
                    ...
                    <a class="pink_list" href="catalog.php?type=2">women</a>
                    <ul>
                        <li><a class="menu_list" href="#">Accessories</a></li>
                    ...
                    <a class="pink_list" href="catalog.php?type=3">kids</a>
                    <ul>
                        <li><a class="menu_list" href="#">Accessories</a></li>
                        <li><a class="menu_list" href="#">Jackets & Coats</a></li>
                        <li><a class="menu_list" href="#">Polos</a></li>
                    ...
                    <a class="pink_list hide_tittle" href="registration.php?action=<?= $reg_way ?>">registration</a>
                    <a class="pink_list hide_tittle" href="reviews.php?rev=1">reviews</a>
                    <a class="pink_list hide_tittle" href="<?= $_SESSION['email'] ? 'cart.php?cart=1' : 'registration.php?action=1' ?>">cart</a>
                </div>
            </details>
            <a class="logo_right_img" href="registration.php?action=<?= $reg_way ?>"><svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a class="logo_right_img add_pos" href="<?= $_SESSION['email'] ? 'cart.php?cart=1' : 'registration.php?action=1' ?>"><svg width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
...
switch ($_GET['action']) {
    case 1:
        $mega_tittle = "AUTHORIZATION";
        break;
    case 2:
        $mega_tittle = "REGISTRATION";
        break;
    case 3:
        $mega_tittle = "REGISTRATION IS SUCCESSFUL!!!";
        break;
    case 4:
        $mega_tittle = "Account";
        break;
