...
class Catalog extends Catalog_template
{
    ...
    public function get_content_cat()
    {
        ...
        $this->content = "C:/openserver/domains/prof6/views/catalog.php";
        return ['content' => $this->content, 'gender' => $this->cat_some_gender];
    }
    public function get_content_prd()
    {
        $this->content = "C:/openserver/domains/prof6/views/product.php";
        return $this->content;
    }
...
?> <div class="product_item">
                    <div class="box_pict">
                        ...
                        <div class="bord_add_to_cart" onclick="addToCart(`<?= $this->cat_type ?>`, `<?= $data['id'] ?>`, `<?= $data['name'] ?>`, ``, `<?= $data['price'] ?>`, `<?= $data['photo_name'] ?>`, 1)">
