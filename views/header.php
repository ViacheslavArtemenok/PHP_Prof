    ...
    <div class="wrap_head">
        <div class="logo_left">
            ...
            <details class="details_search">
                ...
                <form class="area_search" action="index.php">
        ...
        <div class="logo_right">
            <details id="header_menu" class="logo_right_img menu">
                ...
                <div class="list_box">
                    ...
                    <a class="pink_list hide_tittle" href="reviews.php?rev=1">reviews</a>
                    <a class="pink_list hide_tittle" href="<?= $_SESSION['email'] ? 'cart.php?cart=1' : 'index.php?c=user&action=1' ?>">cart</a>
                </div>
            </details>
            ...
            <a class="logo_right_img" href="reviews.php?rev=1"><svg width="29" height="29" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <a class="logo_right_img add_pos" href="<?= $_SESSION['email'] ? 'cart.php?cart=1' : 'index.php?c=user&action=1' ?>"><svg width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
