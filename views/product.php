    <nav>
        ...
        <div class="prd_back">
            <div class="prd_wrap" style="background-image: url(img/<?= $_POST['gender'] ?>/<?= $_POST['photo_name'] ?>)">
    ...
    <div class="box_collection">
        ...
        <div class="collection_add_box" onclick="addToCart(`<?= $_POST['number_g'] ?>`, `<?= $_POST['id'] ?>`, `<?= $_POST['name'] ?>`, ``, `<?= $_POST['price'] ?>`, `<?= $_POST['photo_name'] ?>`, 1)">
